...
return [
    ...
    | as many connections as you like.x`
    |
            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_prefix' => env('ADLDAP_ACCOUNT_PREFI', 'altoros\\'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'altoros.corp')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'OU=Users,OU=Altoros,DC=altoros,DC=corp'),
